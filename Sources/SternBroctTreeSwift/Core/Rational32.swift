...
public struct Rational32 : Fraction {
    ...
    public func simplified() -> Rational32 {
    ...
    public func addingReportingOverflow(_ other: Rational32) -> (partialValue: Rational32, overflow: Bool) {
        ...
        while retry {
            ...
            if isROverflowed || isSOverflowed || isNumeratorOverflowed || isDenominatorOverflowed {
                ...
                if !x.canSimplify && !y.canSimplify {
                    ...
                    return (Rational32(numerator, denominator), true)
                }
        ...
        return (Rational32(numerator, denominator).simplified(), false)

    }

    public func subtractingReportingOverflow(_ other: Rational32) -> (partialValue: Rational32, overflow: Bool) {
        return addingReportingOverflow(-other)
    }

    public func multipliedReportingOverflow(by other: Rational32) -> (partialValue: Rational32, overflow: Bool) {
        var x = self
        var y = other
    ...
    public func dividedReportingOverflow(by other: Rational32) -> (partialValue: Rational32, overflow: Bool) {
        return multipliedReportingOverflow(by: Rational32(other.denominator, other.numerator))
    }
    ...
    public mutating func negate() {
        if numerator == Int32.min {
            ...
            if simplified.numerator == Int32.min {
                ...
                self = Rational32(simplified.numerator, simplified.denominator * -1)
            }
        }
        self = Rational32(numerator * -1, denominator)
    }
    ...
    public func backwardingMatrixSequence() -> [Matrix2x2] {
        ...
        while continueFraction.numerator > 1 || continueFraction.denominator > 1 {
            ...
            continueFraction = Rational32(numerator: continueFraction.denominator, denominator: continueFraction.mixedRemainder)
        }
